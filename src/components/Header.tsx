...
const Header: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    ...
    },
    {
      ...
      path: '/passers',
      submenu: [
        { title: '실시간 합격자', path: '/passers/realtime' },
      ],
    },
    {
      title: '온라인상담',
      path: '/consultation',
      submenu: [
        { title: '수강 문의', path: '/consultation/inquiry' },
      ],
    },
    {
      title: '커뮤니티',
      ...
      <HeaderContainer>
        <Nav>
          ...
          <SocialIcons>
            ...
            <SocialLink href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer" aria-label="인스타그램">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <SocialLink href="https://www.youtube.com/" target="_blank" rel="noopener noreferrer" aria-label="유튜브">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
