...
// 시설 이미지 URL 생성 헬퍼 함수
const getFacilityImage = (folder: string, filename: string): string =>
  getS3ImageUrl(`${folder}/${filename}`);
...
const facilitiesData: FacilitiesData = {
  ...
  '강남점 본관': [
    { id: 4, name: '2층 로비', image: getFacilityImage('강남점 본관 시설 사진', '2층 로비.PNG') },
    {
      id: 5,
      name: '본관 상담실',
      image: getFacilityImage('강남점 본관 시설 사진', '본관 상담실.jpg'),
    },
    ...
    { id: 8, name: '본관 2층C', image: getFacilityImage('강남점 본관 시설 사진', '본관 2층C.jpg') },
    {
      id: 9,
      name: '본관 3층 무용실',
      image: getFacilityImage('강남점 본관 시설 사진', '본관 3층 무용실.jpg'),
    },
    {
      id: 10,
      name: '3층C 강의실',
      image: getFacilityImage('강남점 본관 시설 사진', '3층C강의실.jpg'),
    },
    {
      id: 11,
      name: '3층B 강의실',
      image: getFacilityImage('강남점 본관 시설 사진', '3층B강의실.jpg'),
    },
    {
      id: 12,
      name: '2층 안내데스크',
      image: getFacilityImage('강남점 본관 시설 사진', '2층 안내데스크.jpg'),
    },
  ],
  '강남점 신관': [
    {
      id: 13,
      name: '신관 무용실',
      image: getFacilityImage('강남점 신관 시설 사진', '신관 무용실.png'),
    },
    {
      id: 14,
      name: '신관 복도',
      image: getFacilityImage('강남점 신관 시설 사진', '신관 복도.png'),
    },
    {
      id: 15,
      name: '신관 연기연습실',
      image: getFacilityImage('강남점 신관 시설 사진', '신관 연기연습실.png'),
    },
  ],
  홍대점: [
    {
      id: 16,
      name: '움직임룸',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스_홍대점_움직임룸.jpg'),
    },
    {
      id: 17,
      name: '보컬룸',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스_홍대점_보컬룸.jpg'),
    },
    {
      id: 18,
      name: '연기룸 2',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스_홍대점_연기룸2.jpg'),
    },
    {
      id: 19,
      name: '연기룸 1',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스_홍대점_연기룸1.jpg'),
    },
    {
      id: 20,
      name: '움직임룸 2',
      image: getFacilityImage('홍대점 시설 사진', '카타르시슷_홍대점_움직임룸2.jpg'),
    },
    {
      id: 21,
      name: '연기룸 5',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스홍대 연기룸5.jpg'),
    },
    {
      id: 22,
      name: '연기룸 3',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스홍대 연기룸3.jpg'),
    },
    {
      id: 23,
      name: '움직임룸 3',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스홍대점 움직임룸3.jpg'),
    },
    {
      id: 24,
      name: '연기룸 4',
      image: getFacilityImage('홍대점 시설 사진', '카타르시스홍대 연기룸4.jpg'),
    },
  ],
};
